...
module('Acceptance | Login', function(hooks) {
  ...
  test('Log in with valid credentials', async function(assert) {
    ...
    assert.equal(currentURL(), '/genres');
    assert.dom('[data-test-rr=genres-empty-message]').hasText("Let's start by creating a genre.", "A descriptive empty message is shown");
